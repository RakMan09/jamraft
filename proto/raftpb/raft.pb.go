...
type LogEntry struct {
	...
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // opaque jukebox command (JSON)
...
type RequestVoteRequest struct {
	...
	PreVote       bool                   `protobuf:"varint,5,opt,name=pre_vote,json=preVote,proto3" json:"pre_vote,omitempty"` // stretch: pre-vote extension
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AppendEntriesResponse struct {
	...
	// Conflict hints for fast log backtracking.
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB*Z(github.com/rakman09/jamraft/proto/raftpbb\x06proto3"
